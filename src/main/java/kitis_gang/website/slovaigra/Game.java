package kitis_gang.website.slovaigra;
...
public class Game {
    ...
    private void getWordsFromFile(){
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/main/resources/database/" +theme+".txt"));
            String str;
    ...
    private void save(){
        try {
            FileWriter writer = new FileWriter("src/main/resources/database/"+theme+".txt", true);
